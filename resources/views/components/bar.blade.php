<!-- component -->
<div class="max-w-sm mx-auto my-4 border-b-2 pb-4">
	<div class="flex pb-3">
		<div class="flex-1">
		</div>

		<div class="flex-1">
			<div class="w-4 h-4 bg-green mx-auto rounded-full text-lg text-white flex items-center">
		...
		<div class="flex-1">
			<div class="w-4 h-4 bg-white border-2 border-grey-light mx-auto rounded-full text-lg text-white flex items-center">
