      <section>
          <div>
              <h2 class="text-orange-900 text-3xl sm:text-4xl font-bold">Job interview: Strengths & Weaknesses</h2>
              <p class="text-gray-500 mt-5 text-justify">During a job interview, the recruiter may ask you this famous question: “Tell me 3 of your strengths and 3 of your weaknesses“. This question (with multiple variations) can be challenging, however, it is a good way of earning points with your recruiter. With a little training and preparation it is easy to make a good impression.</p>
          </div>
          <div>
              <h2 class="text-orange-900 text-3xl sm:text-4xl font-bold">Advice</h2>
              <p class="text-gray-500 mt-5 text-justify">Firstly, here is a bit of advice on how to best answer the question: “What are your strengths and weaknesses?” It is much easier to discuss your strengths than it is your weaknesses. If you are short on ideas, ask those around you for inspiration and advice.</p>
              <p class="text-gray-500 mt-5 text-justify">Here are a few tips for talking about your weak points with peace of mind:</p>
              <ul class="text-gray-500 mt-5 text-justify">
          ...
          <div>
              ...
              <p class="text-gray-500 mt-5 text-justify">Talking about your strengths is a golden opportunity to highlight your successes. When you discussing one of your strengths, illustrate it with a concrete example.
              ...
              <p class="text-gray-500 mt-5 text-justify">Here is a list of qualities that are highly appreciated by recruiters:</p>
              <ul class="text-gray-500 mt-5 text-justify">
          ...
          <div>
              ...
              <p class="text-gray-500 mt-5 text-justify">Stating a “weakness” during a job interview can be unsettling. Indeed, you are here to “sell yourself” yet they ask you to sabotage yourself? In fact, not really.
          ...
          <div>
              <p class="text-gray-500 mt-5 text-justify">Attention: some weak points such as aggressiveness, laziness, lack of rigour, pretension must be avoided. They will work against you no matter what type of position you are aiming for.</p>
              <p class="text-gray-500 mt-5 text-justify">You are now ready to talk about your strengths and weaknesses successfully at your next job interview! Don’t forget that everyone has weaknesses, including your recruiter. Just make sure you explain your point and illustrate it so that it shows your strengths.</p>
          </div>
      </section>
