<form wire:submit.prevent="updatePost">
            ...
            <div class="w-full pt-4">
                <div x-show="openTab === 1">
                    ...
                    <div class="flex flex-1">
                        <div class="mb-4 w-1/2 mr-2">
                            <x-jet-label value="schedule" class="bold" />
                            <x-jet-input type="text" class="w-full" name="schedule" wire:model="schedule"/>
                        </div>
                        <div class="mb-4">
                ...
                <div x-show="openTab === 3">
                    ...
                    <div class="mb-4 mx-2">
                        ...
                        <x-jet-input type="text" class="w-full" name="state" wire:model="state"/>
    ...
    <x-slot name="footer">
        <div>
            <x-jet-secondary-button wire:click="$set('showJob',false)">
                Back
