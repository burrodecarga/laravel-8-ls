<div class="grid grid-cols-1 md:grid-cols-5 gap-2">
                ...
                <form class="flex flex-row flex-wrap p-4 bg-white rounded">
                    ...
                    <div class="w-full md:flex-1 ml-2">
                        ...
                        <x-jet-input id="skill" type="text" class="mt-1 block w-full" wire:model.defer="skill"
                            autocomplete="skill" placeholder=" Enter skills (e.g. Web Designer)" />
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium cursor-pointer">
                                            <a class="text-red-600 hover:text-red-900" wire:click="destroy({{$s->id}})">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
    ...
    <div class="col-span-5 md:col-start-5 my-auto">
        <h1 class="text-2xl font-bold mb-16 text-center">List of User</h1>
        <hr class="my-3">
        <x-admin-nav-menu />
    </div>
</div
